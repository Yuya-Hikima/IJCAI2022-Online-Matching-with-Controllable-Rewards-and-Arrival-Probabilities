...
- **Criwd-sourcing_experiment** Folder containing the python code needed for the experiment
  ...
  - **bin** 
    ...
    - **experiment_crowdsourcing_gurobi.py** Experimental code to replace the above if you do not have a globi license
